...
from wies.projects.models import Colleague, Brand, Assignment, Service, Placement
...
def sync_all_otys_iir_records():
    ...
    with transaction.atomic():
        brand, created = Brand.objects.get_or_create(name='I-Interim Rijk')  # TODO: now hardcoded on IIR
