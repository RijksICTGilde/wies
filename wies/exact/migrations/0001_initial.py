# Generated by Django 5.2.4 on 2025-08-06 07:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aantal_uren', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Aantal uren')),
                ...
                ('if_kf', models.CharField(choices=[('IF', 'IF'), ('KF', 'KF')], max_length=2, verbose_name='IF/KF')),
                ('uren_schrijven', models.BooleanField(default=True, verbose_name='Uren schrijven - nodig voor RC')),
                ('email', models.EmailField(max_length=254, verbose_name='E-mail - gebruikt door RC')),
