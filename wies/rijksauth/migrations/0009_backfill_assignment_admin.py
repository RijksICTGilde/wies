...
loses the assignment rights that address list used to carry.

Only that role: user administration hung on the Django permissions of the
Beheerder group, never on this address list.
