...
0011 renames it on to its key, ``office_assistant``; the screen name lives in
``ROLE_LABELS``. If both groups already exist, the members and permissions of
Beheerder are merged into Gebruikersbeheer and Beheerder is removed.
"""
