// NDD client modal — open nldd-window na HTMX swap, sluit via data-nldd-action.
(function () {
  "use strict";

  const MODAL_ID = "nldd-client-modal";
  const CONTAINER_ID = "nldd-client-modal-container";
