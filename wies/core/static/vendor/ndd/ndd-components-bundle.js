...
const r$4 = (t2) => new n$5("string" == typeof t2 ? t2 : t2 + "", void 0, s$4), i$6 = (t2, ...e3) => {
...
let y$1 = class y extends HTMLElement {
  ...
  _$ET(t2, s2) {
    ...
    if (void 0 !== e3 && true === i4.reflect) {
      const h2 = (void 0 !== i4.converter?.toAttribute ? i4.converter : u$4).toAttribute(s2, i4.type);
  ...
  _$AK(t2, s2) {
    ...
    if (void 0 !== e3 && this._$Em !== e3) {
      const t3 = i4.getPropertyOptions(e3), h2 = "function" == typeof t3.converter ? { fromAttribute: t3.converter } : void 0 !== t3.converter?.fromAttribute ? t3.converter : u$4;
      this._$Em = e3;
      const r2 = h2.fromAttribute(s2, t3.type);
      this[e3] = r2 ?? this._$Ej?.get(e3) ?? r2, this._$Em = null;
    }
  }
  requestUpdate(t2, s2, i4, e3 = false, h2) {
    if (void 0 !== t2) {
      const r2 = this.constructor;
      if (false === e3 && (h2 = this[t2]), i4 ?? (i4 = r2.getPropertyOptions(t2)), !((i4.hasChanged ?? f$1)(h2, s2) || i4.useDefault && i4.reflect && h2 === this._$Ej?.get(t2) && !this.hasAttribute(r2._$Eu(t2, i4)))) return;
      this.C(t2, s2, i4);
    }
    false === this.isUpdatePending && (this._$ES = this._$EP());
  }
  C(t2, s2, { useDefault: i4, reflect: e3, wrapped: h2 }, r2) {
    i4 && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t2) && (this._$Ej.set(t2, r2 ?? s2 ?? this[t2]), true !== h2 || void 0 !== r2) || (this._$AL.has(t2) || (this.hasUpdated || i4 || (s2 = void 0), this._$AL.set(t2, s2)), true === e3 && this._$Em !== t2 && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t2));
  }
  async _$EP() {
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y2 = /^(?:script|style|textarea|title)$/i, x = (t2) => (i4, ...s2) => ({ _$litType$: t2, strings: i4, values: s2 }), b = x(1), w = x(2), E = /* @__PURE__ */ Symbol.for("lit-noChange"), A = /* @__PURE__ */ Symbol.for("lit-nothing"), C = /* @__PURE__ */ new WeakMap(), P = l$1.createTreeWalker(l$1, 129);
function V(t2, i4) {
...
const N = (t2, i4) => {
  ...
  for (let i5 = 0; i5 < s2; i5++) {
    ...
    l2 += c2 === v$1 ? s3 + r$2 : d2 >= 0 ? (e3.push(a2), s3.slice(0, d2) + h$1 + s3.slice(d2) + o$6 + x2) : s3 + o$6 + (-2 === d2 ? i5 : x2);
  }
  return [V(t2, l2 + (t2[s2] || "<?>") + (2 === i4 ? "</svg>" : 3 === i4 ? "</math>" : "")), e3];
};
class S {
    ...
    for (; null !== (r2 = P.nextNode()) && d2.length < u2; ) {
      if (1 === r2.nodeType) {
        if (r2.hasAttributes()) for (const t3 of r2.getAttributeNames()) if (t3.endsWith(h$1)) {
          const i5 = v2[a2++], s2 = r2.getAttribute(t3).split(o$6), e4 = /([.?@])?(.*)/.exec(i5);
        ...
        if (y2.test(r2.tagName)) {
          const t3 = r2.textContent.split(o$6), i5 = t3.length - 1;
          if (i5 > 0) {
...
function M$1(t2, i4, s2 = t2, e3) {
  if (i4 === E) return i4;
  let h2 = void 0 !== e3 ? s2._$Co?.[e3] : s2._$Cl;
  const o2 = a$1(i4) ? void 0 : i4._$litDirective$;
  return h2?.constructor !== o2 && (h2?._$AO?.(false), void 0 === o2 ? h2 = void 0 : (h2 = new o2(t2), h2._$AT(t2, s2, e3)), void 0 !== e3 ? (s2._$Co ?? (s2._$Co = []))[e3] = h2 : s2._$Cl = h2), void 0 !== h2 && (i4 = M$1(t2, h2._$AS(t2, i4.values), h2, e3)), i4;
}
class R {
  constructor(t2, i4) {
  ...
  u(t2) {
    const { el: { content: i4 }, parts: s2 } = this._$AD, e3 = (t2?.creationScope ?? l$1).importNode(i4, true);
    P.currentNode = e3;
...
class k {
  ...
  constructor(t2, i4, s2, e3) {
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t2, this._$AB = i4, this._$AM = s2, this.options = e3, this._$Cv = e3?.isConnected ?? true;
  }
  get parentNode() {
  ...
  _$AI(t2, i4 = this) {
    t2 = M$1(this, t2, i4), a$1(t2) ? t2 === A || null == t2 || "" === t2 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t2 !== this._$AH && t2 !== E && this._(t2) : void 0 !== t2._$litType$ ? this.$(t2) : void 0 !== t2.nodeType ? this.T(t2) : d(t2) ? this.k(t2) : this._(t2);
  }
  O(t2) {
  ...
  $(t2) {
    const { values: i4, _$litType$: s2 } = t2, e3 = "number" == typeof s2 ? this._$AC(t2) : (void 0 === s2.el && (s2.el = S.createElement(V(s2.h, s2.h[0]), this.options)), s2);
  ...
  k(t2) {
    ...
    const i4 = this._$AH;
    let s2, e3 = 0;
    for (const h2 of t2) e3 === i4.length ? i4.push(s2 = new k(this.O(c$1()), this.O(c$1()), this, this.options)) : s2 = i4[e3], s2._$AI(h2), e3++;
...
class H {
  ...
  constructor(t2, i4, s2, e3, h2) {
    this.type = 1, this._$AH = A, this._$AN = void 0, this.element = t2, this.name = i4, this._$AM = e3, this.options = h2, s2.length > 2 || "" !== s2[0] || "" !== s2[1] ? (this._$AH = Array(s2.length - 1).fill(new String()), this.strings = s2) : this._$AH = A;
  }
  _$AI(t2, i4 = this, s2, e3) {
    const h2 = this.strings;
    let o2 = false;
    if (void 0 === h2) t2 = M$1(this, t2, i4, 0), o2 = !a$1(t2) || t2 !== this._$AH && t2 !== E, o2 && (this._$AH = t2);
    else {
      const e4 = t2;
      let n3, r2;
      for (t2 = h2[0], n3 = 0; n3 < h2.length - 1; n3++) r2 = M$1(this, e4[s2 + n3], i4, n3), r2 === E && (r2 = this._$AH[n3]), o2 || (o2 = !a$1(r2) || r2 !== this._$AH[n3]), r2 === A ? t2 = A : t2 !== A && (t2 += (r2 ?? "") + h2[n3 + 1]), this._$AH[n3] = r2;
    }
    o2 && !e3 && this.j(t2);
  }
  j(t2) {
...
const D = (t2, i4, s2) => {
  ...
  if (void 0 === h2) {
    ...
    e3._$litPart$ = h2 = new k(i4.insertBefore(c$1(), t3), t3, void 0, s2 ?? {});
  }
...
const o$4 = { attribute: true, type: String, converter: u$4, reflect: false, hasChanged: f$1 }, r$1 = (t2 = o$4, e3, r2) => {
...
const e$4 = (e3, t2, c2) => (c2.configurable = true, c2.enumerable = true, Reflect.decorate && "object" != typeof t2 && Object.defineProperty(e3, t2, c2), c2);
function e$3(e3, r2) {
  return (n3, s2, i4) => {
...
let NDDButton = class extends i$3 {
  constructor() {
    super(...arguments);
...
`;
const e2 = e$2(class extends i$2 {
  constructor(t2) {
...
function tooltipTemplate(component) {
  return b`
		...
		></slot>
		<div class=${e2({ tooltip: true, "is-visible": component._visible && !component._focusVisible, "is-focus-visible": component._visible && component._focusVisible })}
			aria-hidden="true"
...
let NDDTooltip = class extends i$3 {
  constructor() {
    super(...arguments);
    this.text = "";
    ...
    this._handleKeyDown = (e3) => {
      if (e3.key === "Escape" && this._visible) {
        this._visible = false;
        this._focusVisible = false;
      }
    };
  ...
  _handleFocusOut(e3) {
    const slot = this.shadowRoot?.querySelector("slot");
    const assigned = slot?.assignedElements({ flatten: true }) ?? [];
    const related = e3.relatedTarget;
  ...
  async _updatePosition() {
    ...
    const { x: x2, y: y3 } = await computePosition(trigger, tooltip, {
...
let NDDIconButton = class extends i$3 {
  constructor() {
    super(...arguments);
    this.variant = "neutral-tinted";
    this.size = "md";
...
let NDDSplitButton = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.variant = "neutral-tinted";
...
let NDDButtonGroup = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
...
`;
const { I: t } = j, i$1 = (o2) => o2, s$1 = () => document.createComment(""), v = (o2, n3, e3) => {
  const l2 = o2._$AA.parentNode, d2 = void 0 === n3 ? o2._$AB : n3._$AA;
  if (void 0 === e3) {
    const i4 = l2.insertBefore(s$1(), d2), n4 = l2.insertBefore(s$1(), d2);
  ...
  return e3;
}, u$2 = (o2, t2, i4 = o2) => (o2._$AI(t2, i4), o2), m = {}, p = (o2, t2 = m) => o2._$AH = t2, M = (o2) => o2._$AH, h = (o2) => {
  o2._$AR(), o2._$AA.remove();
};
const u$1 = (e3, s2, t2) => {
  const r2 = /* @__PURE__ */ new Map();
  for (let l2 = s2; l2 <= t2; l2++) r2.set(e3[l2], l2);
  return r2;
  ...
  dt(e3, s2, t2) {
    ...
    const l2 = [], o2 = [];
    let i4 = 0;
    for (const s3 of e3) l2[i4] = r2 ? r2(s3, i4) : i4, o2[i4] = t2(s3, i4), i4++;
  ...
  update(s2, [t2, r2, c2]) {
    ...
    else if (void 0 === m2 && (m2 = u$1(a2, k2, w2), y3 = u$1(h$12, x2, j2)), m2.has(h$12[x2])) if (m2.has(h$12[j2])) {
      const e3 = y3.get(a2[k2]), t3 = void 0 !== e3 ? d2[e3] : null;
      if (null === t3) {
        const e4 = v(s2, d2[x2]);
        u$2(e4, p$12[k2]), v$12[k2] = e4;
      } else v$12[k2] = u$2(t3, p$12[k2]), v(s2, d2[x2], t3), d2[e3] = null;
      k2++;
    } else h(d2[j2]), j2--;
    else h(d2[x2]), x2++;
    for (; k2 <= w2; ) {
      const e3 = v(s2, v$12[w2 + 1]);
...
let NDDButtonBar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.variant = "neutral-tinted";
...
`;
const n$1 = "important", i3 = " !" + n$1, o$2 = e$2(class extends i$2 {
  constructor(t2) {
  ...
  update(e3, [r2]) {
    ...
    for (const t2 in r2) {
      ...
      if (null != e4) {
        ...
        t2.includes("-") || r3 ? s2.setProperty(t2, r3 ? e4.slice(0, -11) : e4, r3 ? n$1 : "") : s2[t2] = e4;
      }
    }
    return E;
  }
...
let NDDToolbar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
...
let NDDRichText = class extends i$3 {
  constructor() {
    super(...arguments);
    this.spacing = "snug";
  }
...
let NDDTitle = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = 3;
  }
		...
		<div class="form-field__header ${isHeaderEmpty ? "is-empty" : ""}">
			${hasLabel ? b`
				<label class="form-field__label"
					@click=${(e3) => component._focusInput(e3)}
				>
					${component.label}
...
let NDDFormField = class extends i$3 {
  constructor() {
    super(...arguments);
...
let NDDTextField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.value = "";
  ...
  return b`
		<div class="password-field__visibility-toggle">
			<ndd-button
				...
				@mousedown=${(e3) => e3.preventDefault()}
			></ndd-button>
		</div>
	`;
}
...
let NDDPasswordField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.value = "";
...
let NDDSearchField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.value = "";
...
let NDDNumberField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.value = 0;
    this.min = -Infinity;
...
let NDDDropdown = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.disabled = false;
...
let NDDIconCell = class extends i$3 {
  constructor() {
    super(...arguments);
...
let NDDSpacerCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "16";
  }
...
function renderText(text) {
  ...
  return b`${parts.map((part, i4) => i4 % 2 === 1 ? b`<b>${part}</b>` : part)}`;
}
function template$a() {
  return b`
...
let NDDTextCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.color = "default";
...
function init() {
  ...
  document.addEventListener("keydown", (e3) => {
    if (["Tab", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "Enter", " ", "Escape"].includes(e3.key)) {
      keyboardMode = true;
    }
  }, { signal });
...
const _NDDMenu = class _NDDMenu extends i$3 {
  ...
  async reposition() {
    ...
    const { x: x2, y: y3 } = await computePosition(anchorEl, this, {
...
let NDDComboBox = class extends i$3 {
  constructor() {
    super(...arguments);
    this.value = "";
    this.placeholder = "";
    ...
    this._handleMenuToggle = (e3) => {
      this._isOpen = e3.newState === "open";
      if (!this._isOpen) {
        this._highlightedId = "";
      } else {
...
let NDDStepper = class extends i$3 {
  constructor() {
    super(...arguments);
    this.value = 0;
    this.min = 0;
...
let NDDCheckbox = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.disabled = false;
...
let NDDCheckboxField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.indeterminate = false;
  ...
  _handleLabelClick(e3) {
    if (this.disabled) return;
    if (e3.target.closest?.("ndd-checkbox")) return;
    const checkbox = this.shadowRoot?.querySelector("ndd-checkbox");
    checkbox?.toggle();
  }
  _handleChange(e3) {
    const { checked } = e3.detail;
...
let NDDRadioButton = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.disabled = false;
...
let NDDRadioButtonField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.disabled = false;
  ...
  _handleLabelClick(e3) {
    if (this.disabled) return;
    if (e3.target.closest?.("ndd-radio-button")) return;
    const radioButton = this.shadowRoot?.querySelector("ndd-radio-button");
    radioButton?.select();
  }
  _handleChange(e3) {
    this.checked = e3.detail.checked;
    this.dispatchEvent(new CustomEvent("change", {
      detail: { checked: this.checked, value: this.value },
      bubbles: true,
      composed: true
...
let NDDRadioButtonGroup = class extends i$3 {
  constructor() {
    super(...arguments);
    this.name = "";
    this.disabled = false;
    ...
    this._handleChange = (e3) => {
      const changedField = e3.target;
    ...
    this._handleKeyDown = (e3) => {
      if (e3.key !== "ArrowDown" && e3.key !== "ArrowUp" && e3.key !== "ArrowRight" && e3.key !== "ArrowLeft") return;
      const fields = this._getEnabledFields();
      if (fields.length === 0) return;
      const activeField = fields.find((f2) => f2.checked) ?? fields[0];
      const currentIndex = fields.indexOf(activeField);
      const isNext = e3.key === "ArrowDown" || e3.key === "ArrowRight";
...
let NDDSwitch = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.disabled = false;
...
let NDDSwitchField = class extends i$3 {
  constructor() {
    super(...arguments);
    this.checked = false;
    this.disabled = false;
  ...
  _handleLabelClick(e3) {
    if (this.disabled) return;
    if (e3.target.closest?.("ndd-switch")) return;
...
let NDDSegmentedControl = class extends i$3 {
  constructor() {
    super(...arguments);
    this.value = "";
    this.values = [];
    ...
    this.accessibleLabelledBy = "";
    this._generatedName = "";
    this._handleItemChange = (e3) => {
      e3.stopPropagation();
      if (this.disabled) return;
      if (this.type === "checkbox") {
        const current = this.values;
        const updated = e3.detail.checked ? [...current, e3.detail.value] : current.filter((v2) => v2 !== e3.detail.value);
        this.values = updated;
        this._syncItems();
        this.dispatchEvent(new CustomEvent("change", {
        ...
        if (e3.detail.value === this.value) return;
        this.value = e3.detail.value;
        this._syncItems();
        this.dispatchEvent(new CustomEvent("change", {
          detail: { value: this.value },
          bubbles: true,
...
let NDDToggleButton = class extends i$3 {
  constructor() {
    super(...arguments);
    this.type = "button";
    this.size = "md";
...
let NDDToggleButtonGroup = class extends i$3 {
  constructor() {
    super(...arguments);
    this.type = "checkbox";
    this.name = "";
    ...
    this._handleKeyDown = (e3) => {
      if (this.type !== "radio") return;
      if (!["ArrowDown", "ArrowUp", "ArrowRight", "ArrowLeft"].includes(e3.key)) return;
...
let NDDToken = class extends i$3 {
  constructor() {
    super(...arguments);
    this.control = "none";
    this.open = false;
...
let NDDAppView = class extends i$3 {
  constructor() {
    super(...arguments);
...
function barSplitViewTemplate(component) {
  ...
  return b`
    ...
    return b`
					<div class=${e2({ "bar-split-view__main": isMain, "bar-split-view__bar": !isMain })}
						style=${o$2(barStyles)}>
...
let NDDBarSplitView = class extends i$3 {
  constructor() {
    super(...arguments);
...
let NDDNavigationSplitView = class extends i$3 {
  constructor() {
    super(...arguments);
  ...
  _handleSidebarSheetClick(e3) {
    if (e3.target === this._sidebarSheet) this.hideSidebarSheet();
  }
  _handleSidebarSheetCancel(e3) {
    e3.preventDefault();
    this.hideSidebarSheet();
  }
  // ----------------------------------------------------------------
  ...
  _handleInspectorSheetClick(e3) {
    if (e3.target === this._inspectorSheet) this.hideInspectorSheet();
  }
  _handleInspectorSheetCancel(e3) {
    e3.preventDefault();
    this.hideInspectorSheet();
  }
  // ----------------------------------------------------------------
...
function sideBySideSplitViewTemplate(component) {
  const panes = Array.from({ length: component.panes }, (_2, i4) => i4 + 1);
  return b`
		<div class="side-by-side-split-view">
			${panes.map((n3, i4) => b`
				${i4 > 0 && i4 < component._visiblePanes ? b`
					<ndd-split-view-divider orientation="vertical"></ndd-split-view-divider>
				` : A}
				<div
					class="side-by-side-split-view__pane"
					?hidden=${i4 >= component._visiblePanes}
				>
					<slot name="pane-${n3}"></slot>
				</div>
			`)}
		</div>
	`;
...
let NDDSideBySideSplitView = class extends i$3 {
  constructor() {
    super(...arguments);
    this.background = "inherit";
    this.panes = 2;
...
let NDDStackedSplitView = class extends i$3 {
  constructor() {
    super(...arguments);
    this.background = "inherit";
    this.panes = 2;
...
let NDDSplitViewPane = class extends i$3 {
  constructor() {
    super(...arguments);
...
let NDDSimpleSection = class extends i$3 {
  _onSlotChange(e3) {
...
let NDDFullBleedSection = class extends i$3 {
  _onSlotChange(e3) {
    const slot = e3.target;
    const wrapper = slot.parentElement;
    wrapper.hidden = slot.assignedElements().length === 0;
...
let NDDOneThirdTwoThirdsSection = class extends i$3 {
  render() {
...
let NDDTwoThirdsOneThirdSection = class extends i$3 {
  render() {
...
let NDDOneHalfOneHalfSection = class extends i$3 {
  render() {
...
function collectionTemplate(component) {
  ...
  return b`
		<div class="collection__items">
			<slot @slotchange=${(e3) => component._onSlotChange(e3)}></slot>
		</div>
...
let NDDCollection = class extends i$3 {
  constructor() {
    super(...arguments);
    this.layout = "grid";
  ...
  _applyVisibility(items) {
    ...
    elements.forEach((el, i4) => {
      el.hidden = i4 >= this._visibleCount;
    });
  }
  _loadMore() {
...
let NDDSpacer = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "16";
    this.direction = "both";
...
let NDDContainer = class extends i$3 {
  constructor() {
    super(...arguments);
    this.padding = void 0;
...
let NDDDivider = class extends i$3 {
  render() {
...
let NDDSheet = class extends i$3 {
  constructor() {
    super(...arguments);
  ...
  _handleDialogClick(e3) {
    if (this.modeless) return;
    if (e3.target === this._dialog) {
      this.hide();
    }
  }
  _handleCancel(e3) {
...
let NDDList = class extends i$3 {
  constructor() {
    ...
    this._onPointerMove = (event) => {
      ...
      this._lastPointerY = event.clientY;
      const items = this._getItems();
      const nonDragging = items.filter((i4) => i4 !== this._draggingEl);
      const pointerY = event.clientY;
      let toIndex = nonDragging.length;
      for (let i4 = 0; i4 < nonDragging.length; i4++) {
        const inner = nonDragging[i4].shadowRoot?.querySelector(".list-item") ?? nonDragging[i4];
  ...
  _setDropIndex(toIndex) {
    ...
    const nonDragging = this._getItems().filter((i4) => i4 !== this._draggingEl);
...
const areas = (showStart, showEnd) => b`
	<div class=${e2({ "list-item__start-area": true, "is-visible": showStart })}>
		<slot name="start">
	...
	<div class=${e2({ "list-item__end-area": true, "is-visible": showEnd })}>
		<slot name="end">
			<ndd-spacer-cell size="12"></ndd-spacer-cell>
		</slot>
	</div>
...
let NDDListItem = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.selected = false;
...
const a = /* @__PURE__ */ Symbol.for(""), o = (t2) => {
  ...
  let c2, $2 = 0, f2 = false;
  for (; $2 < a2; ) {
    for (c2 = r2[$2]; $2 < a2 && void 0 !== (i4 = e3[$2], s2 = o(i4)); ) c2 += s2 + r2[++$2], f2 = true;
...
let NDDTitleCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = 5;
    this.color = "default";
...
let NDDDescriptionCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.width = "stretch";
    this.verticalAlignment = "center";
...
let NDDDragHandleCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.size = "md";
    this.translations = {};
...
let NDDTimelineTrackCell = class extends i$3 {
  constructor() {
    super(...arguments);
    this.step = "past";
    this.child = "between";
...
NDDTimelineTrackCell.styles = i$6`
		:host {
			display: flex;
			flex-direction: column;
			align-items: center;
...
let NDDMenuBarItem = class extends i$3 {
  constructor() {
    super(...arguments);
    this.text = "";
    this.current = false;
...
let NDDMenuBar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.overflowText = "";
    this.accessibleLabel = "";
  ...
  _updateOverflow() {
    ...
    for (let i4 = 0; i4 < items.length; i4++) {
      const itemWidth = items[i4].offsetWidth;
      const availableWidth = containerWidth - overflowButtonWidth;
      if (usedWidth + itemWidth > availableWidth && overflowStartIndex < 0) {
        overflowStartIndex = i4;
        break;
      }
      usedWidth += itemWidth;
    }
    if (overflowStartIndex >= 0) {
      for (let i4 = overflowStartIndex; i4 < items.length; i4++) {
        items[i4].style.display = "none";
        items[i4].setAttribute("data-overflow", "true");
      }
    } else {
      overflowButton.style.display = "none";
    }
...
let NDDSkipLink = class extends i$3 {
  constructor() {
    super(...arguments);
    this.text = "";
    this.href = "";
...
let NDDTopNavigationBar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.websiteTitle = "";
    this.noLogo = false;
...
let NDDTopTitleBar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.text = "";
    this.supportingText = "";
...
let NDDTabBar = class extends i$3 {
  constructor() {
    super(...arguments);
    this.compact = false;
    this.responsive = false;
...
function documentTabBarTemplate(component) {
  ...
  const inner = b`
		...
		<div class=${e2({ "document-tab-bar__overflow": true, "is-hidden": !hasOverflow })}>
			<ndd-icon-button
...
let NDDDocumentTabBar = class extends i$3 {
  constructor() {
    super(...arguments);
    ...
    this._onPointerMove = (event) => {
      ...
      const visibleItems = this._getVisibleItems().filter((i4) => i4 !== this._draggingEl);
      const pointerX = event.clientX;
      let toIndex = visibleItems.length;
      for (let i4 = 0; i4 < visibleItems.length; i4++) {
        const inner = visibleItems[i4].shadowRoot?.querySelector(".document-tab-bar__item") ?? visibleItems[i4];
        const rect = inner.getBoundingClientRect();
    ...
    this._handleItemDismiss = (event) => {
      ...
      if (dismissedItem.selected) {
        ...
        for (let i4 = index + 1; i4 < items.length; i4++) {
          if (!items[i4].hidden) {
            nextItem = items[i4];
            break;
          }
    ...
    this._handleKeyDown = (event) => {
      ...
      if (items.length === 0) return;
      const currentIndex = items.findIndex(
        (i4) => i4 === event.target || i4.contains(event.target)
      );
      let newIndex = -1;
      switch (event.key) {
        case "ArrowLeft":
  ...
  _setDropIndex(toIndex) {
    if (!this._placeholder || !this._draggingEl) return;
    const nonDragging = this._getVisibleItems().filter((i4) => i4 !== this._draggingEl);
    const clamped = Math.max(0, Math.min(nonDragging.length, toIndex));
    this._currentDropIndex = clamped;
    this._placeholder.remove();
    if (nonDragging.length === 0) {
  ...
  _ensureSelectedVisible() {
    const items = this._getItems();
    const visibleCount = items.length - this._overflowCount;
    const selectedIndex = items.findIndex((i4) => i4.selected);
			...
			<div class="pagination__compact">
				<div class="pagination__select-wrapper">
					<select class="pagination__select"
						...
						?disabled=${isDisabled}
						@change=${(e3) => component._goToPage(Number(e3.target.value))}
					>
						${Array.from({ length: component.total }, (_2, i4) => i4 + 1).map((page) => b`
...
let NDDPagination = class extends i$3 {
  constructor() {
    super(...arguments);
    this.current = 1;
    this.total = 1;
  ...
  _getVisiblePages() {
    if (this.total <= 7) {
      return Array.from({ length: this.total }, (_2, i4) => i4 + 1);
    }
    if (this.current <= 3) {
...
let NDDInlineDialog = class extends i$3 {
  constructor() {
    super(...arguments);
    this.variant = "";
    this.iconName = "";
...
let NDDModalDialog = class extends i$3 {
  constructor() {
    super(...arguments);
    this.variant = "";
    this.iconName = "";
  ...
  _handleBackdropClick(e3) {
    if (e3.target === this._dialog) this.hide();
  }
  _handleCancel(e3) {
    e3.preventDefault();
    this.hide();
