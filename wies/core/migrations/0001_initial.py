        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("VACATURE", "VACATURE"), ("INGEVULD", "INGEVULD")], default="LEAD", max_length=20
                    ),
                ),
                ...
                (
                    "ministry",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to="core.ministry"),
                ),
            ],
        ),
        migrations.CreateModel(
