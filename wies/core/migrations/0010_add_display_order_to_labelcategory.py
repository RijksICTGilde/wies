    ...
    operations = [
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=100, help_text="Lagere waarden verschijnen eerst in filters", verbose_name="Weergavevolgorde"
            ),
        ),
        ...
        migrations.AlterModelOptions(
            name="labelcategory",
            options={
                "ordering": ["display_order", django.db.models.functions.text.Lower("name")],
        ...
        migrations.AlterField(
            ...
            name="display_order",
            field=models.PositiveIntegerField(
                default=wies.core.models.get_next_display_order,
