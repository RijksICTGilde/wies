...
from wies.core.roles import is_bdm_request, is_staff_member
...
def show_bm_page(request) -> bool:
    """Whether to show the "Business management" section."""
    return is_bdm_request(request)


def show_staff_pages(request) -> bool:
    """Whether to show the application-administration pages (Statistieken, Database)."""
