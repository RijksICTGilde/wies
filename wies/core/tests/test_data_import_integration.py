...
Assignment 2,Test,Owner B,ownerb@test.com,,01-01-2025,31-12-2025,Java,Jane Smith,jane@test.com,I-Interim Rijk,Rijks ICT Gilde"""
    ...
    def test_csv_assignment_import_existing_colleague_no_duplicate_label(self):
        ...
        csv_content = """assignment_name,assignment_description,assignment_owner,assignment_owner_email,assignment_organization_url,assignment_start_date,assignment_end_date,service_skill,placement_colleague_name,placement_colleague_email
