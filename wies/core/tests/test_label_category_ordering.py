...
from wies.core.models import LabelCategory, Label, get_next_display_order
...
class LabelCategoryOrderingTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cat_merk = LabelCategory.objects.create(
            name='Merk', color='#DCE3EA', display_order=30
        )
        self.cat_expertise = LabelCategory.objects.create(
            name='Expertise', color='#B3D7EE', display_order=10
        )
        self.cat_thema = LabelCategory.objects.create(
            name='Thema', color='#FFE9B8', display_order=20
        )
