...
from wies.core.views import UserListView, user_create, user_edit, user_delete, user_import_csv, widget_email_row
...
urlpatterns = [
    ...
    path('widgets/email-row/', widget_email_row, name='widget-email-row'),
]
