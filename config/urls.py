...
urlpatterns = [
    ...
    path("beheer/labels/<int:pk>/", label_form, name="label-form-edit"),
    ...
    path("beheer/merken/<int:pk>/bewerken/", suborganization_edit, name="suborganization-edit"),
    path("beheer/merken/<int:pk>/verwijderen/", suborganization_delete, name="suborganization-delete"),
