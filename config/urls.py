...
from wies.core.views import (
    ...
    contact,
    contract_period_add,
    contract_period_delete,
    contract_period_edit,
    delete_error,
    error_400,
    error_403,
    error_404,
...
urlpatterns = [
    ...
    path("beheer/rollen/", role_matrix, name="role-matrix"),
    ...
    path("contracturen/collega/<uuid:colleague_public_id>/", contract_period_add, name="contract-period-add"),
    path("contracturen/<uuid:public_id>/", contract_period_edit, name="contract-period-edit"),
    path("contracturen/<uuid:public_id>/verwijderen/", contract_period_delete, name="contract-period-delete"),
