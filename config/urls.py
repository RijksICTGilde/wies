...
from wies.core.views import (
    ...
    organization_admin,
    privacy,
    rijksprofielservice_authorize,
    rijksprofielservice_callback,
    rijksprofielservice_disconnect,
    robots_txt,
    search_suggestions,
    staff_dashboard,
    staff_database,
...
urlpatterns = [
    ...
    path("profielservice/koppel/", rijksprofielservice_authorize, name="rijksprofielservice-authorize"),
    path("profielservice/callback/", rijksprofielservice_callback, name="rijksprofielservice-callback"),
    path("profielservice/ontkoppel/", rijksprofielservice_disconnect, name="rijksprofielservice-disconnect"),
