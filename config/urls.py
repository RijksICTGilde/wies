...
urlpatterns = [
    ...
    path("opdracht/<int:pk>/bewerken/", assignment_edit_view, name="assignment-edit"),
    path("opdracht/<int:pk>/teamlid/", assignment_member_edit_view, name="assignment-member-edit"),
    path(
        "opdracht/<int:pk>/teamlid/<int:service_id>/verwijderen/",
        assignment_member_delete_view,
