...
urlpatterns = [
    ...
    path("beheer/labels/categorie/<uuid:public_id>/bewerken/", label_category_edit, name="label-category-edit"),
    path("beheer/labels/categorie/<uuid:public_id>/verwijderen/", label_category_delete, name="label-category-delete"),
    path("beheer/labels/categorie/<uuid:public_id>/labels/aanmaken/", label_create),
