...
urlpatterns = [
    ...
    path(
        "business-management/",
        RedirectView.as_view(pattern_name="bench-overview", permanent=False),
        name="business-management",
    ),
    path("business-management/bezetting/", bench_overview, name="bench-overview"),
    path("business-management/prognose/", bm_prognose, name="bm-prognose"),
    path("business-management/opdrachten/", bm_opdrachten, name="bm-opdrachten"),
