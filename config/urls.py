...
urlpatterns = [
    ...
    path("beheer/merken/", suborganization_admin, name="merk-admin"),
    path("beheer/merken/aanmaken/", suborganization_create, name="merk-create"),
    path("beheer/merken/<int:pk>/bewerken/", suborganization_edit, name="merk-edit"),
    path("beheer/merken/<int:pk>/verwijderen/", suborganization_delete, name="merk-delete"),
