...
- Authenticatie: Rijks SSO, alleen expliciet toegevoegde ODI-gebruikers; beheerd via speciale rol (“Gebruikersbeheer”), die alleen door platformbeheer wordt toegekend. Elke wijziging aan de gebruikerslijst wordt gelogd en kan later geïnspecteerd worden.
