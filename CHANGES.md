...
- 603: een opdrachtkaart zonder rollen draagt het label "Nog geen rollen", en de periode-rij staat er voortaan altijd, met "Geen periode opgegeven" als er geen datum is. Zonder die twee zag zo'n kaart er kaal en korter uit dan de rest, zonder dat je wist waarom; nu lijnen alle kaarten in het raster uit en zegt de kaart zelf wat er ontbreekt. De betekenis zit in de tekst en niet in een kleur (WCAG 1.4.1)
- 603: een opdracht zonder rollen staat weer in de lijst op `/opdrachten/`. De lijst selecteerde op opdrachten met minstens één openstaande, onbezette rol, en een net ingevoerde opdracht heeft er nog geen: je maakte hem aan en kon hem daarna nergens meer terugvinden. Er is nu een tweede voorwaarde bij, voor opdrachten die nog helemaal geen rol hebben. Let op: het rol- en expertisefilter gaan via de rollen, dus zo'n opdracht verdwijnt zodra je daarop filtert
