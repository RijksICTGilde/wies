...
- 483: the concurrent-edit warning on a single text field now shows the value that is stored at that moment, so you can see what saving anyway would overwrite
