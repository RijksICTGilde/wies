...
- de melding dat een plaatsing beperkt zichtbaar is, ziet er nu overal hetzelfde uit: een doorgestreept oog met de zin erachter, zoals op de opdrachtkaarten al gebeurde. In het opdrachtpaneel zat die zin nog ingebed in een omhullende tekst ("De geplaatste teamleden zijn …") met een kleingemaakte eerste letter, en stond hij in dezelfde alinea als de melding over de externe bron; die twee staan nu los van elkaar. De variant voor een afgelopen opdracht waar je BM was ("… jou en het team") stond hardcoded in de view en is verhuisd naar `placement_visibility.py`, waar de andere twee al stonden
