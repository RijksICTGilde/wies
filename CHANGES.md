...
- 659: contract hours per week are recorded as periods with a start and end date, by the colleague on their own profile or by a beheerder on the user sheet, so a change of hours keeps the history
- 659: a role on an opdracht (aanvraag or placed consultant) records its hours per week; the team list, the Aanvragen cards and the Bezetting bars show them
