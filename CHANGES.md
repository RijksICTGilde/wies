...
- 483: inline editing now detects concurrent edits instead of silently overwriting: if the data changed since you opened the edit form, the save is rejected with a message to reload the page. Applies to individual fields and the team form.
