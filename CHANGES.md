...
- 632: the base dummy fixture now ships a user account and role per colleague, so an environment seeded with it alone (a PR preview via /staff/, for one) shows a populated Bezetting instead of an empty one
- ?
